...
(* NOTE FAIL: single_rel contains top, that isn't support fully *)
...
Proof.
  rewrite rt_union_singl. (* rewrite crE, seq_singl_max_rt; relsf. *)
  hkat'.
Qed.
